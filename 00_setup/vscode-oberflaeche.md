...
Über das **Farbdesign** (Theme) passt man Helligkeit und Kontrast an — das wirkt oft schon wie eine „aufgeräumtere“ Oberfläche.

1. Die **Befehlspalette** öffnen: `Strg+Shift+P` (Windows/Linux) bzw. `Cmd+Shift+P` (macOS).
2. **Color Theme** bzw. **Farbdesign** eintippen und **Einstellungen: Farbdesign** / **Preferences: Color Theme** wählen.
3. In der Liste kann man mit den **Pfeiltasten** durch die Themes wechseln und so live vergleichen.

![Farbdesign wechseln — Befehlspalette und Theme-Auswahl](./VSC_screenshots/VSC_change_visual_design.png)

Im Workshop ist z. B. ein helles Theme wie **Arduino Light** gut lesbar — man findet es in den Erweiterungen (Suchbegriff z. B. `Arduino Light`) und wählt es danach ebenfalls unter **Farbdesign**.

![Beispiel: Arduino Light Theme](./VSC_screenshots/VSC_arduinoL_theme.png)

---

## Aktivitätsleiste aufräumen

Die **Aktivitätsleiste** ist die vertikale Leiste ganz links (Dateien, Suche, Git, Erweiterungen …). Einträge, die man selten braucht, kann man ausblenden — **Rechtsklick** auf die Leiste und die nicht benötigten Ansichten abwählen.
