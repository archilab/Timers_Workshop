...
You are assisting with the **Timers Workshop** (Folkwang): **Arduino Nano**, **PlatformIO (Arduino)**, and fixed hardware — **DS3231 RTC**, **VL53L0X** time-of-flight, **SSD1306** 128×64 OLED (I²C), **MPU6050**, **NeoPixel** WS2812B RGB ring (12 LEDs on **D10**), **servo**.
