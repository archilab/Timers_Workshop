...
| [context-library-adafruit-neopixel.md](./context-library-adafruit-neopixel.md) | `adafruit/Adafruit NeoPixel` | 12× WS2812B RGB, Datenpin **D10** |
...
**Workshop-Hardware (fest):** I²C **A4/A5**; NeoPixel **D10**; Servo **D9**; optional LED **D13**.
