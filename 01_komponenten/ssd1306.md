...
Das **OLED** (Organic Light-Emitting Diode) ist ein kleines **Display**, auf dem du **Text**, **Zahlen** und **einfache Grafik** sehr gut lesen kannst — selbst bei normaler Raumbeleuchtung. Im Workshop nutzen wir ein **128×64**-Panel mit dem Chip **SSD1306** und Anbindung über **I²C** (nur wenige Kabel zum Arduino Nano).
...
- **SSD1306:** Das ist der **Display-Controller** auf dem Breakout-Board. Die Software spricht mit diesem Chip — du musst die Pixel nicht einzeln „anpinseln“, das übernimmt die Library.
...
## Was du typischerweise auf dem Modul siehst
...
| Adresse | **0x3C** (nur wenn dein Modul **0x3D** zeigt: in Code und Doku anpassen) |
...
## Wofür du das OLED nutzt

- **Uhrzeit und Datum** von der **DS3231** anzeigen  
- **Abstände** vom **VL53L0X** als Zahl oder Balken  
- **Beschleunigung**, **Neigung** oder **Temperatur** vom **MPU6050** (wenn du sie im Prompt verlangst)  
